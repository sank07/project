...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1063584979ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce_db&table=users">`ecommerce_db`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce_db&table=products">`ecommerce_db`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce_db&table=password_resets">`ecommerce_db`.`password_resets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce_db&table=purchases">`ecommerce_db`.`purchases`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6530333b47467742704c4b2f553c3658">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="ecommerce_db" targettable="purchases">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `purchases`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="password_resets">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">describe users;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="ecommerce_db" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SHOW INDEX FROM products;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DESCRIBE products;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="ecommerce_db" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">-- Create the orders table with correct foreign key references
CREATE TABLE orders (
